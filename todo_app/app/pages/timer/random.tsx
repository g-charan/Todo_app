        ...
        <div className=" w-full grid grid-cols-2 h-[85%] grid-rows-3">
          ...
          <div className=" row-span-1 col-span-2 ">
            ...
            <div className=" h-[80%] flex gap-2 px-4">
              <div className=" relative w-2/3 flex  border-zinc-500 p-2 rounded-xl flex-col   ">
                <QuoteGenerator />
              </div>
              <div className="  flex-1 rounded-xl  h-full items-center self-center place-self-center border-zinc-500">
                <MusicPlayer />
              </div>
            </div>
          </div>
